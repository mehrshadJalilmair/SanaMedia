...
var FilterAlbums:[Music] = [Music]()

class AlbumFilter: UIViewController , UITableViewDelegate , UITableViewDataSource , UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
    ...
    @objc func GenresClicked()
    {
        ...
        let url_dynamic_part:String = String.localizedStringWithFormat(singleton.URLS["genres"]!, "music_album")
    ...
    func GenresSelected()
    {
        ...
        Alamofire.request(url , method: .get , encoding: URLEncoding.default).validate().responseJSON { response in
            ...
            case .success:
                ...
                let images = data["music_albums"] as! [AnyObject]
...
extension AlbumFilter
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row + 1 == FilterAlbums.count {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        controller.album = FilterAlbums[indexPath.row]
