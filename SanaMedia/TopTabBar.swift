...
public protocol SlidingContainerSliderViewDelegate: class {
    func slidingContainerSliderViewDidPressed (_ slidingtContainerSliderView: TopTabBar, atIndex: Int)
}
...
public class TopTabBar: UIView {
    ...
    public init(width: CGFloat, titles: [String]) {
        super.init(frame: CGRect (x: 0, y: 55, width: width, height: sliderHeight))
        self.titles = titles
    ...
    public func labelWithTitle(_ title: String) -> UILabel {
        ...
        label.addGestureRecognizer(UITapGestureRecognizer (
            target: self,
            action: #selector(TopTabBar.didTap(_:))))
