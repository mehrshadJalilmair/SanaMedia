...
var EbookGenres:[String] = [String]()
var FilterEbooks:[EBook] = [EBook]()

class EbookFilter: UIViewController , UITableViewDelegate , UITableViewDataSource , UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
    ...
    @objc func GenresClicked()
    {
        ...
        let url_dynamic_part:String = String.localizedStringWithFormat(singleton.URLS["genres"]!, "ebook")
    ...
    func GenresSelected()
    {
        //let genre_first_level = EbookGenres[selectedGenreIndex]
        let splited = EbookGenres[selectedGenreIndex].split(separator: "-")
        let genre_first_level = String(splited[0])
        
        let url_dynamic_part:String = String.localizedStringWithFormat(singleton.URLS["ebooks_by_category"]!, "\(pageSize)" , "\(newsPageIndex+1)" , genre_first_level.addingPercentEncoding(withAllowedCharacters:NSCharacterSet.urlQueryAllowed)!)
        let url = Singleton.getInstance().url_static_part + url_dynamic_part
...
extension EbookFilter
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row + 1 == FilterEbooks.count {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        controller.ebook = FilterEbooks[indexPath.row]
